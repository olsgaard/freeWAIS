...
/* list words and their stemmed version in the log*/
/* #define LIST_STEMS */
...
#ifdef LIST_STEMS
/*
** - duplicate our word so that 
**   we can provide a better listing
*/
	char *word_copy;
	
	word_copy = s_malloc(strlen(word+5));
...
#ifdef LIST_STEMS
/*
** - put up the original word and the stemmed version
*/
waislog(WLOG_LOW, WLOG_INFO,"word: %s,  stemmed word: %s", word_copy, word); 
s_free(word_copy);
#endif
